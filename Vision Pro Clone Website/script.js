function loco(){
  ...
  gsap.to("#page15>img",{
      scrollTrigger:{
          trigger:`#page15>img`,
          start:`top bottom`,//When top of the element touches the bottom of the screen 
          end:`bottom 30%`,//When bottom of the element reaches 30% of the screen from bottom
          scrub:.5,
          scroller:`#main`
      },
      opacity:1
